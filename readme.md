...
* Сохранение в базе MongoDB файлов, передаваемых в обоих направлениях (кроме файлов ПО)
...
#### Распознавание устройств и их типов
 Параметр | Описание
----------|---------
dev_types | Соответствие идентификаторов типов устройств и названиям.
